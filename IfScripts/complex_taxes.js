...
let federalTax = taxRate * annualGrossPay;
let tax = federalTax / 100;
let netpay = annualGrossPay - tax;
// output
console.log("fed tax for " + filingStatus + " with a weekly gross pay of " + weeklyGrossPay.toFixed(2) + " is "
    + /*keeps giving not a number*/ federalTax.toFixed(2));

// pt 2 of exercise


console.log("you worked " + hoursWorked + " this year and earned " + payRate.toFixed(2) + " so your gross pay is " + annualGrossPay
    + ", your filing status is " + filingStatus + " so your tax witholdings this year is " + /*got NaN*/ tax.toFixed(2) + " your net pay is " + /*got NaN*/netpay.toFixed(2));
